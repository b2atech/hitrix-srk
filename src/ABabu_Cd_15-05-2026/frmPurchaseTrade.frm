...
Begin VB.Form frmPurchaseTrade 
   ...
   Begin Crystal.CrystalReport cryReport 
      Bindings        =   "frmPurchaseTrade.frx":058A
      Left            =   4110
      Top             =   0
      _ExtentX        =   741
      _ExtentY        =   741
...
Select Case Index
    Case 5  '-- Party   Alias Account
        If frmTypeStr = "PE" Then
           gClsSearch.SearchMultiField "QryMastAccount", "Account,AcOurCode,CGName,AcContPer,AcCity,AgName,AcBST,AcMsOmsParty", Array("Account Name", "Code", "Party Group", "Contact Person", "City", "Group", "TIN", "Ms/Oms"), Array(4000, 1000, 2000, 2000, 2000, 2500, 0, 0), "(Agcode in (90029) and AcIsExemptMill = 1 )", Trim(Chr(KeyAscii)), "", LeftPos, TopPos, True
        Else
