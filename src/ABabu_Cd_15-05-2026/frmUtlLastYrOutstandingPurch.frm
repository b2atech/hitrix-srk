...
Case 4 'Find
    If gBackEndDB = gBackEndAccess Then '--Access
        gClsSearch.SearchMultiField "tblOutstanding,tblMastAccount", "VNo,Vtype,iif(VType='PY','Trade','Sale In Transit') ))),VDt,OutBillNo,AcName,OutAmount,OutItShort,OutTicket", Array("VNo", "Vtype", "Type", "Date", "Bill No", "Party", "Amount", "Short", "Ticket"), Array(800, 0, 1500, 1200, 1000, 1800, 1200, 1000, 1000), "  outaccode=AcCode and Vyear=" & gCYear - 1 & " and vtype in ('PY','PT') ", "", "Vdt,Vno", 0, 0
    Else '--Oracle
...
Private Sub Form_Load()
    ...
    ConditionStr = " where Vyear=" & gCYear - 1 & " and Vtype in ('PY','PY')"
