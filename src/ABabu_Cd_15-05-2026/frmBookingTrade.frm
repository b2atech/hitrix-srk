...
Begin VB.Form frmBookingTrade 
   ...
   Begin Crystal.CrystalReport cryReport 
      Bindings        =   "frmBookingTrade.frx":058A
      Left            =   4110
      Top             =   0
      _ExtentX        =   741
      _ExtentY        =   741
   ...
   Begin VB.Label Label6 
      BackColor       =   &H00EFB17A&
      Caption         =   "   Booking For Trade  Purchase"
      BeginProperty Font 
         Name            =   "Times New Roman"
         Size            =   15.75
         Charset         =   0
...
'    End If
    ...
    If GProcValidateTranCd(frmTypeStr, Cbo(22).Text, txt(35), lblTinNo.Caption, lblMsOms.Caption) = False Then
