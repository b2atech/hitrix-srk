...
Begin VB.Form frmOsAdjustment 
   ...
   Begin Crystal.CrystalReport cryReport 
      Bindings        =   "frmOsAdjustment.frx":058A
      Left            =   12375
      Top             =   180
      _ExtentX        =   741
      _ExtentY        =   741
   ...
   End
End
Attribute VB_Name = "frmOsAdjustment"
...
If txt(0) = "" Or GProcIsDateValid(dtpDt(2)) = False Then
...
X = "select VCtrNo,VBillNo,VBillType,VBillDate, AcOurCode,AcName,VBillAmt, VAmt,left(VRefTp,1),VRefTp,VRefNo,VRefBank, VBillVYear,VBillVno," _
...
& " DbNtMonthly,VBillFirm,DbNtInBillNo,JvNoIntInDepot,CgstRt,CgstAmt,SgstRt,SgstAmt,IgstRt,IgstAmt,CrDrNoteNo,IsGSTDbNt " _
...
With msGrid
    .Clear
    .FormatString = ">Sr|<Bill No           |<Tp ||<Party Code|<Party Name                                      |>Bill Amt          |>Recd. Amt     |   |<Ref  |<Ref.No.     |<Note                                                    ||||||||||||||||||||||||||||||"
    .ColWidth(3) = 0
    .ColWidth(8) = 0
    .ColWidth(9) = 0
    .ColWidth(10) = 0
...
With msGrid
    ...
    If KeyAscii = 13 Then
        KeyAscii = 0
        If .Col = rsRecVsSale.Fields.Count - 31 Then '-4
...
End If
If msGrid.Col < (rsRecVsSale.Fields.Count - 30) Then '- -3
    ...
    With msGrid
        ...
        If .Row > 1 Then
           If msGrid.TextMatrix(.Row, 5) = msGrid.TextMatrix(.Row - 1, 5) Then
              msGrid.TextMatrix(.Row, 10) = msGrid.TextMatrix(.Row - 1, 10)
               ...
               If .Col = 1 Then
                  .TextMatrix(J, 1) = UCase(txtGrid)
                   X = "select tblMastAccount.AcOurCode,tblMastAccount.AcName,SlBillNo,VType,format(Vdt,'dd/MM/yyyy'),SlBillAmt,SlBillAmt-SlBillRecdAmt," _
                        ...
                        & " SlBillNo = '" & .TextMatrix(J, 1) & "' and vfirm in (" & BillsInFirm & ") "
               End If
                i = GProcRstOpen(rstblBlChk, X, "R")
                If i = 0 Then
                   MsgBox "No Data"
                ...
                If i > 0 Then
                   ...
                   .TextMatrix(.Row, 2) = rstblBlChk.Fields(3)  '--Type
                   ...
                   End If
                   .TextMatrix(.Row, 12) = CLng(rstblBlChk.Fields(7)) '--Year
...
'        End Select
    End If
    '--- Navigate Row ,Col
    If KeyAscii = 13 And .Col < rsRecVsSale.Fields.Count - 31 Then '- -4
        If .Col = 8 Then
            .Col = .Col + 3
        ...
        Else
            .Col = .Col + 1
        End If
    ElseIf KeyAscii = 13 And .Col = rsRecVsSale.Fields.Count - 31 Then '- -4
        If .Row = (.rows - 1) Then
            .rows = .rows + 1
            .Row = .Row + 1
        Else
...
With msGrid
    ...
    Do While i < .rows
        ...
        If CDec(Val(.TextMatrix(i, 7))) <> 0 Then
            ...
            rstbl!VBillType = .TextMatrix(i, 2) & vbNullString
