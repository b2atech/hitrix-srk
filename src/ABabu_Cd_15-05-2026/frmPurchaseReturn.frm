...
Begin VB.Form frmPurchaseReturn 
   ...
   Begin VB.Frame Frame1 
      Appearance      =   0  'Flat
      BackColor       =   &H00FFC0C0&
      Caption         =   "Purchase Return / Shortage  Printing"
      BeginProperty Font 
   ...
   Begin Crystal.CrystalReport cryReport 
      Bindings        =   "frmPurchaseReturn.frx":058A
      Left            =   4110
      Top             =   0
      _ExtentX        =   741
      _ExtentY        =   741
...
'    dtpDt(2) = Format(Now, "dd/MM/yyyy")
    ...
    '--A/C
    txttemp(6) = GProcGetColumnValue("tblMastAccount", "AcCode", CStr(gAcCodeVY), "N", "AcName", "S")
    SetGrid
Case 7 'Modify
...
Case 8 'Delete
    ...
    End If
Case 9 'Print
    Frame1.Caption = "Purchase Return / Shortage Printing "
    '-- Inv No
...
'''   lblSGstRate.Caption = "S GST @  : "
'''   lblCGstRate.Visible = True
...
'''   lbl2.Visible = False
'''   lbl3.Visible = False
''''   txttemp(35).Visible = False
''''   lblTrCode.Visible = False
...
End If
txt(68).Enabled = False '-- Ass Val
txt(69).Enabled = False '-- Ass Val
txt(70).Enabled = False '-- Ass Val
...
Case 0, 1:
    ...
    cryReport.WindowTitle = "Purchase Return / Shortage Print"
    '-- A/C Bill SrNo
    ...
    X = Left(X, Len(X) - 1) + ")"
    Y = X
    X = "Select a.Vno,a.Vtype,a.Vdt,a.Vyear,a.VFirm,a.PurAcCrCode,a.PurAcDrCode,a.PurMillCode,a.PurBroker,a.PurBillNo,a.PurBillDt,a.PurTransport,a.PurLorryNo,a.PurLrNo,a.PurLrDate, " _
        & "a.PurSubAmt,a.PurBillAmt,a.PurAdd1,a.PurLess1,a.PurTaxableAmt,a.PurTaxCode,a.PurTaxRate,a.PurTaxAmt,a.PurTaxableAmt2,a.PurTaxRate2,a.PurTaxAmt2, " _
        & " a.PurAftTaxAdd1,a.PurAftTaxLess1,a.PurRoff,a.DueDays,a.DueDate,a.PurEntDt,'" & gUserName & "',a.PurTaxRate3, " _
        & " a.PurTaxAmt3,b.PurSubItCode,b.PurSubBag,b.PurSubWt,b.PurSubRt,b.PurSubNetRate,b.PurSubRtPer,b.PurSubAmt, " _
        & " b.PurSubGodown,b.PurSubLotNo,a.PurTcsOnAmt,a.PurTcsRate,a.PurTcsAmt from tblPurch A ,tblPurchSub B" _
   ...
   gCn.Execute " insert into tmpSale (Vno,Vtype,Vdt,Vyear,VFirm,SlAcDrCode,SlAcCrCode,SlMillCode,SlBroker,SlBillNo,SlBillDt,SlTransport,SlLorryNo,SlLrNo,SlLrDate, " _
               & "SlSubAmt,SlBillAmt,SlAdd1,SlLess1,SlTaxableAmt,SlTaxCode,SlTaxRate,SlTaxAmt,SlTaxableAmt2,SlTaxRate2,SlTaxAmt2," _
               & " SlAftTaxAdd1,SlAftTaxLess1,SlRoff,DueDays,DueDate,SlEntDt,SlUser,SlTaxRate3, " _
               & " SlTaxAmt3,SlSubItCode,SlSubBag,SlSubWt,SlSubRt,SlSubNetRate,SlSubRtPer,SlSubItAmt, " _
               & " SlSubGodown,SlTmpChr1,SlTcsOnAmt,SlTcsRate,SlTcsAmt) " & X
     With cryReport
        ...
        .ReportFileName = gReportPath & "rptPurchRtnPrintGst.rpt"
