...
Begin VB.Form frmBookingTradePurch 
   BackColor       =   &H00FBF2E1&
   BorderStyle     =   0  'None
   ...
   FillColor       =   &H000040C0&
   FillStyle       =   0  'Solid
   Icon            =   "frmBookingTradePurch.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.ComboBox Cbo 
      ...
      Height          =   390
      Index           =   34
      ItemData        =   "frmBookingTradePurch.frx":058A
      Left            =   2340
      List            =   "frmBookingTradePurch.frx":0597
      TabIndex        =   18
      Text            =   "Cbo(34)"
      Top             =   5220
      Width           =   2400
   ...
   Begin VB.ComboBox Cbo 
      ...
      Height          =   390
      Index           =   43
      ItemData        =   "frmBookingTradePurch.frx":05C0
      Left            =   2340
      List            =   "frmBookingTradePurch.frx":05CD
      TabIndex        =   17
      Text            =   "Cbo(43)"
      Top             =   4770
      Width           =   2400
   ...
   Begin VB.ComboBox Cbo 
      ...
      Height          =   390
      Index           =   42
      ItemData        =   "frmBookingTradePurch.frx":05EC
      Left            =   2340
      List            =   "frmBookingTradePurch.frx":05FC
      TabIndex        =   16
      Text            =   "Cbo(42)"
      Top             =   4365
      Width           =   2400
   ...
   Begin VB.ComboBox Cbo 
      ...
      Height          =   390
      Index           =   22
      ItemData        =   "frmBookingTradePurch.frx":0623
      Left            =   2340
      List            =   "frmBookingTradePurch.frx":062D
      TabIndex        =   15
      Text            =   "Cbo(22)"
      Top             =   3960
      Width           =   2400
   ...
   Begin Crystal.CrystalReport cryReport 
      Bindings        =   "frmBookingTradePurch.frx":064F
      Left            =   4110
      Top             =   0
      _ExtentX        =   741
      _ExtentY        =   741
   ...
   End
End
Attribute VB_Name = "frmBookingTradePurch"
...
Case 9 'Print
    ...
    txtMailDesc.text = "Please find attached herewith Purchase Order"
    chkOff.Enabled = True
    chkOff.Value = 1
    ChkCus.Enabled = True
    ChkCus.Value = 1
...
'        .Formulas(11) = "wBSTNo = '" & gCBST & "'"
        ...
        .SelectionFormula = X
        .ReportFileName = gReportPath & "rptBookingPrint_Purch.rpt"
         ...
         Else
               .Formulas(12) = "wCopy = 'Mill Copy'"
                    ...
                    Set objCrystal = New CRAXDRT.Application
                     Tattach = gReportPath & "rptBookingPrint_Purch.rpt"
...
'                        objReport.FormulaFields(j).text = "Trim(" & Chr(39) & "Mail Copy" & Chr(39) & ")"
            ...
            '            txt(9).SetFocus
                   ...
                   Mfile = CStr(App.Path) + "\MailPDF\" + gCCode + "-" + gUserName + "-" + "Purch_Booking"
...
'                   PtyMailIdBcc = GProcGetColumnValue("tblMastAccount", "AcCode", RsSA!AdAcDrCode, "N", "AcEmailBcc", "S")
                  ExportReportToPDF objReport, Mfile & ".pdf", "foo"
                   ...
                   Mfile = CStr(App.Path) + "\MailPDF\" + gCCode + "-" + gUserName + "-" + "Purch_Booking.pdf"
'                   Mfile = gReportPath & "rptBookingPrint_MillBill.pdf"
                   
                   
                   MailSub = "Purchase Order No  " & YY
                   MailStr = "Dear Sir, " + Chr(13) + Chr(10)
                   MailStr = MailStr + " " & txtMailDesc & " "
                   
'                   MailStr = "Dear Sir, " & vbLf
...
GProcCheckForNumber Me, rstbl, MaxNo, , Array(25, 26, 37, 38)
...
Select Case Index
    ...
    Case 6  '-- Mill  Code
         ...
         X = "Select Acname from tblMastAccount,tblMastBillSerial where tblMastaccount.Accode = tblMastBillSerial.MillCode  and tblMastBillSerial.Vfirm = '" & gCCode & "'   and  tblMastaccount.AcOurCode = '" & UCase(txtCode(6)) & "'   and  tblMastBillSerial.SaleType = " & MilTpCd & "    "
...
'         gClsSearch.SearchMultiField "tblMastaccount,tblMastBillSerial", "BillSr,AcName,AcOurCode", Array("Mill Ini.", "Mill Name", "Code"), Array(0, 8000, 1000), ShowMill, Trim(Chr(KeyAscii)), "AcName", LeftPos, TopPos, True
        gClsSearch.SearchMultiField "tblMastaccount", "AcOurCode,AcName,AcCity", Array("Code", "Mill Name", "City"), Array(1000, 7000, 2000), "(AgCode=90029) ", Trim(Chr(KeyAscii)), "AcName", LeftPos, TopPos, True
        KeyAscii = 0
        txtCode(6) = ""
        If gClsSearch.SearchMultiRetCol(1) <> "" Then
            txttemp(Index) = gClsSearch.SearchMultiRetCol(1)
            txtCode(6) = gClsSearch.SearchMultiRetCol(0)
        End If
        If mLastEntryMill <> txttemp(6) And FormAction = vbDataActionAddNew Then
           txttemp(17) = ""
           txtStdPack = 0
...
'        MillCtrlEd
    ...
    Case 17  '-- Item
         ...
         If gClsSearch.SearchMultiRetCol(0) <> "" And gClsSearch.SearchMultiRetCol(4) = 0 Then
             ...
             txt(20) = 0
             lblHsnCd.Caption = GProcGetColumnValue("tblMastItem", "ItName", txttemp(17), "S", "ItHsn2", "S", " ItMillCode=" & MillCode)
         End If
    Case 24 '-- Party Group
...
If gCYear >= 2021 Then
   MillCode = GProcGetColumnValue("TblMastAccount", "AcName", txttemp(6), "S", "Accode", "N")
   HsnNm = GProcGetColumnValue("tblMastItem", "ItName", txttemp(17), "S", "ItHsn2", "S", " ItMillCode=" & MillCode)
   If Len(HsnNm) < 6 Then
...
End If
'If DelNote = False And FormAction = vbDataActionAddNew Then
'   If txt(26) = "" Then
'      txt(26) = "As Per Schedule"
''   Else
...
'   End If
'End If
'If DelNote = True And FormAction = vbDataActionAddNew Then
'   If txt(26) = "" Then
'      txt(26) = "As Per Advice"
''   Else
...
Cbo(34).ListIndex = Val(txt(34))
lblHsnCd = ""
MillCode = GProcGetColumnValue("TblMastAccount", "AcName", txttemp(6), "S", "Accode", "N")
lblHsnCd = GProcGetColumnValue("tblMastItem", "ItName", txttemp(17), "S", "ItHsn2", "S", " ItMillCode=" & MillCode)
