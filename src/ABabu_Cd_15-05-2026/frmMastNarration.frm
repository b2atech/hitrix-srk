...
Case 3 'Last
    ...
    ReadFields
Case 4 'Find
    gClsSearch.SearchMultiField tblName, "Narration", Array("Narration"), Array(txt(2).Width), " not Narration = '-' and   NarrType='" & mNarrTp & "'", "", "Narration", txt(2).Left + Me.Left, txt(2).Top + Me.Top + 650
...
Private Sub Form_Load()
    ...
    Case "S": '--Sizer
        Label6.Caption = "    Party Bank Master"
        lbl1(0).Caption = "Bank Name      :"
    Case "C": '-- Consignee Master
         Label6.Caption = "    Consignee Master"
         lbl1(0).Caption = "Consignee Name :"
         lbl1(1).Visible = True
         txt(24).Visible = True
         txt(25).Visible = True
         For i = 3 To 6
...
SaveBtnEd
If (mNarrTp = "N" Or mNarrTp = "S") And Index = 2 And cmdBtn(13).Enabled = True Then
   cmdBtn(13).SetFocus
End If
End Sub
