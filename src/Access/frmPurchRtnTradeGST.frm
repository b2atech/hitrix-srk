...
Begin VB.Form frmPurchRtnTradeGST 
   BackColor       =   &H00C2E3FC&
   BorderStyle     =   0  'None
   ...
   FillColor       =   &H000040C0&
   FillStyle       =   0  'Solid
   Icon            =   "frmPurchRtnTradeGST.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin Crystal.CrystalReport cryReport 
      Bindings        =   "frmPurchRtnTradeGST.frx":058A
      Left            =   4110
      Top             =   0
      _ExtentX        =   741
      _ExtentY        =   741
   ...
   End
End
Attribute VB_Name = "frmPurchRtnTradeGST"
...
Case 6 'Add
    ...
    '--A/C
    txttemp(3) = GProcGetColumnValue("tblMastAccount", "AcCode", CStr(gAcCodePY), "N", "AcName", "S")
    SetGrid
Case 7 'Modify
...
'        rsVouSub!vsubLRNO = txtVsub(19) & vbNullString
        ...
        X = "select tblAddLess.vno,tblAddLess.vtype,tblAddLess.vdt,tblAddLess.vyear,tblAddLess.AdBillAmt from tblAddLess,tblVousub where tblAddLess.Vno = tblVouSub.Vno and tblAddLess.Vtype = tblVouSub.Vtype and tblAddLess.Vyear = tblVouSub.Vyear and  tblVouSub.VSubItCtrlNo = " & CLng(.TextMatrix(i, 25)) & ""
...
If frmTypeStr <> "PI" Then
    ...
    GProcCreateVoucher FormAction, txt(0), 1, txt(2), txt(1), DrCode, CrCode, -(txt(11)), txtVou(11), BillDt, "", "Bill No " & txtVou(11) & " Dtd. " & BillDt
    GProcCreateVoucher FormAction, txt(0), 2, txt(2), txt(1), CrCode, DrCode, (txt(11) - TaxAmt), txtVou(11), BillDt, "", "Bill No " & txtVou(11) & " Dtd. " & BillDt
    i = 3
    If Val(txtCGSTAmt) > 0 Then
       GProcCreateVoucher FormAction, txt(0), i, txt(2), txt(1), TaxAcCodeCGST, DrCode, Val(txtCGSTAmt), txtVou(11), BillDt, "", "Bill No " & txtVou(11) & " Dtd. " & BillDt
       i = i + 1
       DoEvents
    End If
    If Val(txtSGSTAmt) > 0 Then
       GProcCreateVoucher FormAction, txt(0), i, txt(2), txt(1), TaxAcCodeSGST, DrCode, Val(txtSGSTAmt), txtVou(11), BillDt, "", "Bill No " & txtVou(11) & " Dtd. " & BillDt
       i = i + 1
       DoEvents
    End If
    If Val(txtIGSTAmt) > 0 Then
       GProcCreateVoucher FormAction, txt(0), i, txt(2), txt(1), TaxAcCodeIGST, DrCode, Val(txtIGSTAmt), txtVou(11), BillDt, "", "Bill No " & txtVou(11) & " Dtd. " & BillDt
       i = i + 1
       DoEvents
    End If
    ...
    Do While Vno <= txtno(1)
        ...
        If GProcRstOpen(Rs1, X, "R") > 0 Then
            With cryReport
                ...
                .ReportFileName = gReportPath & "rptPurchRtnPrint.rpt"
                .Action = 1
            End With
        End If
        Vno = Vno + 1
...
Select Case Index
    Case 4  '-- Party   Alias Account
        ...
        AgCode = GProcGetColumnValue("tblMastAccount", "AcName", txttemp(4), "S", "AgCode", "N")
        If AgCode = 90029 Then
            txttemp(5) = txttemp(4) '-- Mill =Party
...
If IsDate(mskDt(2)) = True Then
    MillCode = GProcGetColumnValue("TblMastAccount", "AcName", txttemp(5), "S", "Accode", "N")
    QStr = " select tblAddless.AdInvNo,format(tblAddless.AdGpdt,'dd/mm/yyyy'),ItName,vsubbag,vsubwt,VSubItCtrlNo,VsubRt,VsubRtPer,VsubCGSTRt,VsubSGSTRt,VsubIGSTRt,tblVousub.VSubItCtrlNo from " _
    ...
    With gClsSearch
        ...
        If .SearchMultiRetCol(0) <> "" Then
           ...
           msGrid.TextMatrix(msGrid.Row, 25) = GProcGetColumnValue("tblVouSub", "VSubItCtrlNo", Val(gClsSearch.SearchMultiRetCol(5)), "N", "VSubItCtrlNo", "N", "")    '--  P ItCtrl No =Book ItCtrl No
           ...
           Chr2 = "select tblAddLess.AdInvNo,tblAddLess.adgpdt from tblAddLess,tblVousub where tblAddLess.Vno = tblVouSub.Vno and tblAddLess.Vtype = tblVouSub.Vtype and tblAddLess.Vyear = tblVouSub.Vyear and  tblVouSub.VSubItCtrlNo = " & CLng(.SearchMultiRetCol(11)) & ""
