...
'--Fill Gp Details
X = "select VSubBag,tblMastAccount.AcName As Party,AdLrDt,AdTmp6 ,AdTmp5 from tblvousub,TblAddLess,tblMastAccount  where " _
& " tblvousub.Vno=TblAddLess.Vno and tblvousub.Vtype=TblAddLess.Vtype and tblvousub.VYear=TblAddLess.Vyear and " _
& " tblvousub.Vno=" & txt(0) & " and tblAddLess.AdAcCrCode = tblMastAccount.AcCode and tblvousub.vtype='GP' and tblvousub.VYear=" & gCYear
    ...
    If GProcRstOpen(RsGp, X, "R") > 0 Then
        With RsGp
            ...
            Else
                mskDt(0) = "__/__/____"
            End If
            txt(1) = .Fields("AdTmp6") & vbNullString '-Vehicle No
...
gCn.Execute "update tblAddLess set AdLRDt=" & DtStr & ",ADTMP6='" & txt(1) & "',AdTmp5='" & txt(2) & "' where Vno=" & CLng(txt(0)) & " and Vtype='GP' and Vyear=" & gCYear
