...
If Val(txtCGSTRcm) + Val(txtSGSTRcm) + Val(txtIGSTRcm) > 0 Then
    ...
    GProcCreateVoucher FormAction, txt(0), 1, txt(2), "SZ", RcmSaleAc, RcmSaleAc, txt(29) - TaxAmt, txt(36), mskDt(2)
    GProcCreateVoucher FormAction, txt(0), 2, txt(2), "SZ", RcmSaleAc, RcmSaleAc, -txt(29), txt(36), mskDt(2)
    i = 3
    If Val(txtCGSTRcm) > 0 Then
       GProcCreateVoucher FormAction, txt(0), i, txt(2), "SZ", TaxAcCodeCGSTRcm, RcmSaleAc, Val(txtCGSTRcm), txt(43), mskDt(9), "", txt(43)
       i = i + 1
       DoEvents
    End If
    If Val(txtSGSTRcm) > 0 Then
       GProcCreateVoucher FormAction, txt(0), i, txt(2), "SZ", TaxAcCodeSGSTRcm, RcmSaleAc, Val(txtSGSTRcm), txt(43), mskDt(9), "", txt(43)
       i = i + 1
       DoEvents
    End If
    If Val(txtIGSTRcm) > 0 Then
       GProcCreateVoucher FormAction, txt(0), i, txt(2), "SZ", TaxAcCodeIGSTRcm, RcmSaleAc, Val(txtIGSTRcm), txt(43), mskDt(9), "", txt(43)
       i = i + 1
       DoEvents
    End If
End If
...
With msGrid
    Do While RowIndex < .rows
        ...
        If Val(.TextMatrix(RowIndex, 4)) > 0 Then
            SubAmt = SubAmt + Val(.TextMatrix(RowIndex, 4))
        End If
