...
Begin VB.Form frmBookingTrade 
   ...
   Begin VB.ComboBox Cbo 
      ...
      Height          =   360
      Index           =   47
      ItemData        =   "frmBookingTrade.frx":058A
      Left            =   6840
      List            =   "frmBookingTrade.frx":0594
      TabIndex        =   3
      Text            =   "Cbo(47)"
      Top             =   1125
      Width           =   2370
   ...
   Begin Crystal.CrystalReport cryReport 
      Bindings        =   "frmBookingTrade.frx":05B1
      Left            =   2820
      Top             =   30
      _ExtentX        =   741
      _ExtentY        =   741
   ...
   End
End
Attribute VB_Name = "frmBookingTrade"
...
Case 6 'Add
    ...
    mskDt(0) = GProcGenerateVDt("tblAddLess", "Vdt", "Vtype='" & frmTypeStr & "' and VYear=" & gCYear)
    IsLockCtrl = False
    SetControlEd
    SetGrid
Case 7 'Modify
...
Select Case Index
    ...
    Case 5  '-- Mill  Alias Account
        ...
        End If
   Case 6 '--- Godown Name
        gClsSearch.SearchMultiField "tblMastNarration", "Narration", Array("Godown"), Array(txttemp(Index).Width), " NarrType='G' ", Chr(KeyAscii), "Narration", 0, 0, True
        KeyAscii = 0
        If gClsSearch.SearchMultiRetCol(0) <> "" Then
...
If txttemp(6) = "" Or IsNull(txttemp(6)) Then
   txttemp(6) = "-"
End If
txt(12) = GProcGetColumnValue("tblMastNarration", "Narration", txttemp(6), "S", "NarrCode", "N")
...
txttemp(6) = GProcGetColumnValue("tblMastNarration", "NarrCode", txt(12), "N", "Narration", "S")
...
Select Case Index
    Case 0, 1:
        ...
        CryReport.WindowTitle = "Trade Booking"
        ...
        CryReport.ReportFileName = gReportPath & "rptBookingTradePrint.rpt"
        CryReport.Action = 1
    Case 2:
        DoEvents
