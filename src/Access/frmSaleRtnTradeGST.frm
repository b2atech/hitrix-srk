...
'If gCYear >= 2020 Then
'    TaxAcCodeCGST = GProcGetColumnValue("tblMastNarration", "Narration", "G S T", "S", "CGSTOutPutAc", "N")
'    TaxAcCodeSGST = GProcGetColumnValue("tblMastNarration", "Narration", "G S T", "S", "SGSTOutPutAc", "N")
'    TaxAcCodeIGST = GProcGetColumnValue("tblMastNarration", "Narration", "G S T", "S", "IGSTOutPutAc", "N")
'Else
...
Case 3, 4:
    ...
    Y = "Select a.Vno,a.Vtype,a.Vdt,a.Vyear,a.AdAcCrCode,a.AdTaxCode,a.AdInvNo,a.Vno,a.AdSubAmt,a.AdBillAmt,b.VsubCGSTRt,b.VsubCGSTAmt,b.VsubSGSTRt,b.VsubSGSTAmt, " _
        ...
        & " where a.vno = b.vno and a.vtype = b.vtype and a.vyear = b.vyear and b.VSubCtrNo = 1 and a.vtype='" & frmTypeStr & "' and a.Vno in " & X & "   "
    gCn.BeginTrans
    ...
    Do While Not Rs1.EOF
       FirmGstin = gCGSTIN
       PartyName = GProcGetColumnValue("tblMastAccount", "AcCode", Rs1.Fields("VACCODE"), "N", "AcName", "S")
       
       PartyGstin = GProcGetColumnValue("tblMastAccount", "AcCode", Rs1.Fields("VACCODE"), "N", "AcGSTIN", "S")
       PartyAdd1 = GProcGetColumnValue("tblMastAccount", "AcCode", Rs1.Fields("VACCODE"), "N", "AcAdd1", "S")
       PartyAdd2 = GProcGetColumnValue("tblMastAccount", "AcCode", Rs1.Fields("VACCODE"), "N", "AcAdd2", "S")
       PartyCity = GProcGetColumnValue("tblMastAccount", "AcCode", Rs1.Fields("VACCODE"), "N", "AcCity", "S")
       PartyPin = GProcGetColumnValue("tblMastAccount", "AcCode", Rs1.Fields("VACCODE"), "N", "AcZip", "S")
       ItemHsn = GProcGetColumnValue("tblMastItem", "ItCode", Rs1.Fields("VACOCODE"), "N", "ITTMP2", "S")
       ...
       Print #1, Space(15) + Chr(34) + "No" + Chr(34) + ":" + Chr(34) + CStr(Rs1.Fields("Vno")) + Chr(34) + Chr(44)
       Print #1, Space(15) + Chr(34) + "Dt" + Chr(34) + ":" + Chr(34) + CStr(Rs1.Fields("Vdt")) + Chr(34)
       Print #1, "}" + Chr(44)
...
'"ShipDtls":{
'               "Gstin":"27AYUPJ8100A1ZK",
'               "LglNm":"Vardhman Texcom ( Jainco Sizing )",
'               "TrdNm":null,
'               "Addr1":"Khanjire Industrial Estate, Shahpur",
'               "Addr2":null,
'               "Loc":"Ichalkaranji",
'               "Pin":416115,
'               "Stcd":"27"
'},
       ...
       Print #1, Space(15) + Chr(34) + "AssVal" + Chr(34) + ":" + Trim(CStr(Format(Rs1.Fields("Amt1"), "############0.00"))) + Chr(44)
       Print #1, Space(15) + Chr(34) + "IgstVal" + Chr(34) + ":" + Trim(CStr(Format(Rs1.Fields("Amt8"), "############0.00"))) + Chr(44)
       Print #1, Space(15) + Chr(34) + "CgstVal" + Chr(34) + ":" + Trim(CStr(Format(Rs1.Fields("Amt4"), "############0.00"))) + Chr(44)
       Print #1, Space(15) + Chr(34) + "SgstVal" + Chr(34) + ":" + Trim(CStr(Format(Rs1.Fields("Amt6"), "############0.00"))) + Chr(44)
       ...
       Print #1, Space(15) + Chr(34) + "OthChrg" + Chr(34) + ":" + Trim(CStr(Format(Rs1.Fields("Amt10"), "############0.00"))) + Chr(44)
       Print #1, Space(15) + Chr(34) + "RndOffAmt" + Chr(34) + ":" + Trim(CStr(Format(Rs1.Fields("Amt9"), "############0.00"))) + Chr(44)
       Print #1, Space(15) + Chr(34) + "TotInvVal" + Chr(34) + ":" + Trim(CStr(Format(Rs1.Fields("Amt2"), "############0.00")))
       Print #1, "}" + Chr(44)
       ...
       Print #1, Space(32) + Chr(34) + "Qty" + Chr(34) + ":" + Trim(CStr(Format(Rs1.Fields("Amt12"), "############0.000"))) + Chr(44)
       Print #1, Space(32) + Chr(34) + "Unit" + Chr(34) + ":" + Chr(34) + "KGS" + Chr(34) + Chr(44)
       Print #1, Space(32) + Chr(34) + "UnitPrice" + Chr(34) + ":" + Trim(CStr(Format(Rs1.Fields("Amt14") / Rs1.Fields("Amt12"), "############0.000"))) + Chr(44)
       Print #1, Space(32) + Chr(34) + "TotAmt" + Chr(34) + ":" + Trim(CStr(Format(Rs1.Fields("Amt14"), "############0.00"))) + Chr(44)
       ...
       Print #1, Space(32) + Chr(34) + "AssAmt" + Chr(34) + ":" + Trim(CStr(Format(Rs1.Fields("Amt1"), "############0.00"))) + Chr(44)
       Print #1, Space(32) + Chr(34) + "GstRt" + Chr(34) + ":" + Trim(CStr(Format(Rs1.Fields("Amt3") + Rs1.Fields("Amt5") + Rs1.Fields("Amt7"), "############0"))) + Chr(44)
       Print #1, Space(32) + Chr(34) + "IgstAmt" + Chr(34) + ":" + Trim(CStr(Format(Rs1.Fields("Amt8"), "############0.00"))) + Chr(44)
       Print #1, Space(32) + Chr(34) + "CgstAmt" + Chr(34) + ":" + Trim(CStr(Format(Rs1.Fields("Amt4"), "############0.00"))) + Chr(44)
       Print #1, Space(32) + Chr(34) + "SgstAmt" + Chr(34) + ":" + Trim(CStr(Format(Rs1.Fields("Amt6"), "############0.00"))) + Chr(44)
       ...
       Print #1, Space(32) + Chr(34) + "TotItemVal" + Chr(34) + ":" + Trim(CStr(Format(Rs1.Fields("Amt1") + Rs1.Fields("Amt8") + Rs1.Fields("Amt4") + Rs1.Fields("Amt6"), "############0.00")))
       Print #1, Space(30) + "}"
       Print #1, Space(30) + "]"
       Rs1.MoveNext
       If Rs1.EOF Then
...
Case 5:
    ...
    Do While sheet.Cells(a, 1) <> ""
       ...
       If i > 1 Then
          gCn.Execute "Update tblAddLess set ADTMP6 = '" & sheet.Cells(a, 2) & "',ADTMP8 = '" & sheet.Cells(a, 3) & "'  where vtype='" & frmTypeStr & "' and VNo= " & sheet.Cells(a, 5) & " and " _
          & " VYear=" & gCYear
       Else
          gCn.Execute "Update tblAddLess set ADTMP6 = '" & sheet.Cells(a, 2) & "',ADTMP8 = '" & sheet.Cells(a, 3) & "'  where AdAcCrCode= " & PtyCd & " and vtype='" & frmTypeStr & "' and Vno= " & sheet.Cells(a, 5) & " and " _
          & " VYear=" & gCYear
       End If
       a = a + 1
    Loop
...
GProcCheckForNumber Me, rstbl, MaxNo, Array(36), Array(44, 46), pOtherTxtFromNo:=OtherTxtFromNo, pOtherTxtToNo:=OtherTxtToNo
End Sub
...
Select Case Index
    ...
    Case 4 '-- Purchase A/c  Alias Account
        gClsSearch.SearchMultiField "QryMastaccount", "Account,AcName,AcCity,AgName", Array("Purchase Account", "AcName", "City", "Group"), Array(3000, 0, 2000, 3000), "(AgCode=90023 or GpCode=90023)", Chr(KeyAscii), "AcName", LeftPos, TopPos, True
        KeyAscii = 0
        If gClsSearch.SearchMultiRetCol(0) <> "" And gClsSearch.SearchMultiRetCol(1) = "" Then
            txttemp(Index) = gClsSearch.SearchMultiRetCol(0)
        Else
...
Dim RsG As Recordset
Dim X As String
'NoStockMill = GProcGetColumnValue("tblMastAccount", "AcName", txtTemp(3), "S", "AcIsNoStockMill", "N")
'
'If NoStockMill = 1 Then
'   IsRelatedItCtrlGatePass = False
'   Exit Function
'Else
    '-- Is Gate Pass
    X = "Select Vno,Vdt from tblVouSub where Vtype='GP' and VSubPItCtrlNo > 0  and " _
    & " VSubPItCtrlNo = " & ItCtrlNo
    GProcRstOpen RsG, X, "R"
    If RsG.EOF Then
    Else
